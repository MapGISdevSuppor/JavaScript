...
OpenLayers.Layer = OpenLayers.Class({
    ...
    /** 
     * APIProperty: displayInLayerSwitcher【是否出现在图层开关控件中】 
  ...
  // OPTIONS
     ...
     *     displaying the whole world.当世界地图不是地理坐标系时就要指定一个最大分辨率 
     */
    maxResolution: null,
