...
OpenLayers.Map = OpenLayers.Class({
  ...
  // Options
     ...
     *
     * Parameters:
     * array - {String} A property on the map whose value is an array.//map装某类对象的属性
     * property - {String} A property on each item of the given array. //某类对象的属性名称
     * match - {String | Object} A string to match.  Can also be a regular  //匹配条件，可以是字符串，也可以是带有test方法的对象
   ...
   /** 
    ...
    setCenter: function (lonlat, zoom, dragging, forceZoomChange) {
        ...
        this.moveTo(lonlat, zoom, {
            'dragging': dragging,
            'forceZosetCenteromChange': forceZoomChange
        });
    },
